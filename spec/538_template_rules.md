...
The bottom safe area must leave clear separation between any x-axis title and the footer. Keep `source_text` concise (normally source name + year); methodology belongs in supporting copy rather than the chart footer.
