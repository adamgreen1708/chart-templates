CHART_CONFIG = {
    ...
    # DATA
    # ---------------------------
    "data_file": "data/james_bond_villain_age_by_bond_era.csv",
    "data_format": "wide",
    "chart_type": "bar",
    "orientation": "horizontal",
    "x_col": "avg_age_gap_years",
    "y_col": "bond_actor",
    "series_col": None,
    "value_col": None,
    "filters": [],
    ...
    "x_is_datetime": False,
    "x_tick_rotation": 0,
    "x_label": "Average villain age minus Bond age (years)",
    "y_label": "",
    "x_margin": 0.04,
    "x_axis": {"min": -8, "max": 20, "tick_interval": 5, "format": ".0f"},
    ...
    # SORTING
    # ---------------------------
    "sort": {"by": "era_order", "ascending": False},
    ...
    # ---------------------------
    "dpi": 200,
    "output_file": "output/bond_villains_03_age_gap_by_bond_era.png",
}
