CHART_CONFIG = {
    ...
    "orientation": None,
    "x_col": "plot_position",
    "y_col": "display_album_with_gap",
    "series_col": None,
    "value_col": None,
    "filters": [],

    "title": "A reinvention score gets awkward",
    "subtitle": "Album labels add the calendar-year gap since the previous release; 23 moves are scored and two remain explicit missing-data rows.",
